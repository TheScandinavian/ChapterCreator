...
# It will be given a name based on your own input - I recommend that you store the script in its own folder.
#
# VERY IMPORTANT:
#
...
# - IS NON-COMMERCIAL, WITH NO MONEY BEING RECEIVED OR PAID ON MY PART. THIS INCLUDES ALL FORMS OF FUNDRAISING ACTIVITY,
#   AND GENERATION OF ANY ADVERTISING REVENUE.
...
# - IS NOT CAPABLE OF, NOR INVOLVED IN, ILLEGALLY DOWNLOADING, UPLOADING, SHARING, OR DISTRIBUTING GAMES WORKSHOP
#   PUBLICATIONS, AUDIO BOOKS, OR OTHER MATERIALS PROTECTED BY COPYRIGHTS.
...
#
# Oh, and it's open source. Do whatever you want with it.
#
...
def function_chapter_creation_table():
    ...
    def function_homeworld_rule():
        ...
        if num_homeworld_rule <= 1:
            ...
            f.writelines("\nStewardship: this Chapter rules the world via a proxy in the form of a local human governor"
                         " or equivalent.")
    ...
    def function_chapter_quirks():
        ...
        if num_quirks <= 2 and "Absolute Colors" not in (Chapter_Quirk_Base, Chapter_Quirk_1, Chapter_Quirk_2,
            ...
            f.writelines("\nSilent: this Chapter's Astartes, for one reason or another, never speak with outsiders, "
                         "relying instead on trusted mortal intermediaries to represent them when communicating with "
                         "the wider Imperium.")
    ...
    with open(chapter_name, "w") as f:
        ...
        f.writelines("\nNeedless to say, this is not their sole means of fighting their enemies, merely the preferred "
                     "manner in which they do so, and the means by which they excel.")
        ...
        if num_chapter_training <= 10:
            ...
            f.writelines("\nFlexibility: this Chapter instills in its Astartes a jack-of-all-trades mentality, whereby "
                         "they perform admirably in most roles. While not specialists, this affords them tremendous "
        ...
        if num_chapter_beliefs <= 60 and Progenitor_Chapter != "Unknown" and Progenitor_Chapter != "Suspected Traitor":
            ...
            f.writelines("Cult of Personality: this Chapter reveres one of its leading figures. This may be limited to "
                         "high esteem for his deeds or the contents of his character, but it may also develop into "
