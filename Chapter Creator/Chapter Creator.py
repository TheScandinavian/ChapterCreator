...
## The following code defines the Chapter's Legend
        ...
        if NumLegendFigure <= 20:
            ...
            elif NumFoundingLegend <= 90 and PrimarisReinforcements == "Yes" or Founding == "Ultima Founding":
...
## The following code defines the deeds of the Chapter's Legend
        ...
        if NumLegendDeeds <= 15:
            ...
            ##recovering lost chapter standard
            ##slaying an enemy who slighted the chapter
            ##recovering lost land raider
            ##directly responsible for saving the fortress-monastery from attackers
            ##recovering lost terminator armor
            ##hunting down and killing traitors
            ##recovering lost gene-seed
            ##preventing the loss of important chapter lore
        elif NumLegendDeeds <= 130:
            f.writelines("\nThis Astartes is remembered for his dedication to the people of the Imperium.")
            ##recovering a vital component to keep a hive city running
            ##directly responsible for saving a hive city from attackers
            ##standing alone between a civilian shelter and the enemies of the imperium fighting for 20 hours straight
            ##
        elif NumLegendDeeds <= 145:
            f.writelines("\nThis Astartes is remembered as an accomplished warrior.")
            ##mastered every weapon in the chapter's arsenal
            ##slew countless enemy champions regardless of faction
            ##achieved such skill with a weapon it was said no one could match him
            ##fought in more battles than anyone else in the chapter, even to this day
            ##
        elif NumLegendDeeds <= 160:
            f.writelines("\nThis Astartes is remembered as an inspiring leader.")
            ##roused his battle brothers to perform great deeds against insurmountable odds across many battles
            ##roused mortal warriors to perform great deeds against insurmountable odds across many battles
            ##
        elif NumLegendDeeds <= 175:
            f.writelines("\nThis Astartes is remembered as a paragon of his craft.")
            ##depends on who the figure is, techmarine, apothecary, etc
...
## The following code defines additional recruiting worlds
        ...
        if NumAdditionalWorlds <= 8:
            ...
            if NumRecruitingWorldNumber <= 5:
                ...
                f.writelines("\nThis Chapter has two recruiting world in addition to its homeworld.")
            elif NumRecruitingWorldNumber <= 11:
                f.writelines("\nThis Chapter has three recruiting world in addition to its homeworld.")
            elif NumRecruitingWorldNumber <= 13:
                f.writelines("\nThis Chapter has four recruiting world in addition to its homeworld.")
            elif NumRecruitingWorldNumber <= 14:
                f.writelines("\nThis Chapter has five recruiting world in addition to its homeworld.")
            f.writelines("\n")    
...
## The following code defines the Chapter's Training
        ...
        if NumAspirantRecruitment <= 10:
            ...
            f.writelines("\Chance: this Chapter recruits its Aspirants based on chance. This may be tested by a lottery, an interpretation of causality, or something else entirely.")
...
## The following code defines the Chapter's Beliefs
        ...
        f.writelines("\n    Chapter Beliefs")
        NumChapterBeliefs = random.randint (1,185)
        print("Chapter Beliefs Roll:")
        print(NumChapterBeliefs)
        if NumChapterBeliefs <= 60:
